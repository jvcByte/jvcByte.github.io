!(function (t, s) {
      ...
      return (
        (n.load = function (e, n, i) {
          if (
            ...
            (e.shouldBackspace = e.options.shouldBackspace),
  ...
  return (function () {
    ...
    return (
      ...
      (s.append = function (t) {
        var s = this,
          e = this.strings[this.strings.length - 1];
        this.strings.push(t),
          (this.sequence = this.strings.map(function (t, s) {
            return s;
          })),
          this.typingComplete &&
            (this.timeout = this.shouldBackspace
              ? setTimeout(function () {
      ...
      (s.lastStringBackspaced = function () {
        (this.arrayPos = 0),
          ...
          this.loop && (this.shuffleStringsIfNeeded(), this.begin());
      }),
      (s.complete = function () {
